  ...
  return (
    <div className="w-[100vw] h-[100vh] flex justify-center items-center gap-[40px] flex-col ">
      <img
        ...
        alt=""
      />
      <div className=" text-[50px] text-gray-50">Choose role</div>
      <div className="flex gap-[40px]">
        <Link href={"/components/Login"}>
          <div className="w-[250px] h-[300px] bg-blue-900 flex items-center justify-center text-[50px] text-gray-50 rounded-lg shadow-lg hover:bg-gray-200 hover:text-blue-800 transition duration-300 ease-in-out">
            User
          </div>
        </Link>
